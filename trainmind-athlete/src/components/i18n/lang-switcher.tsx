...
/**
 * Selettore lingua dell'app atleti.
 *
 * Scrive sullo store globale: la scelta viene salvata in localStorage e,
 * se c'e' una sessione attiva, propagata al profilo utente sul server.
 */
  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      <button
        ...
        aria-expanded={open}
        className="flex items-center gap-1.5 rounded-lg border border-slate-300 bg-white/80 px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800/80 dark:text-slate-200 dark:hover:bg-slate-700"
      >
