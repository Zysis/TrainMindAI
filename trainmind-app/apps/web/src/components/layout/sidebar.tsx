...
export function Sidebar() {
  ...
  return (
    <aside
      data-tour="sidebar"
      className={cn(
        'fixed left-0 top-0 z-40 flex h-screen flex-col bg-slate-900 shadow-sidebar transition-[width] duration-300',
    ...
    >
      ...
      <div className={cn('border-t border-slate-800 py-3', collapsed ? 'px-2' : 'px-3')}>
        ...
        <button
          onClick={toggle}
          className={cn(
            'mt-2 flex w-full items-center rounded-lg p-2.5 text-sm font-medium text-slate-400 dark:text-slate-500 transition-colors hover:bg-slate-800 hover:text-white',
